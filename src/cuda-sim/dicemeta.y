...
/*----------------------------------------------------------------------------
  Declare tokens.
----------------------------------------------------------------------------*/
%token DBB_ID UNROLLING_FACTOR UNROLLING_STRATEGY LAT IN_REGS OUT_REGS LD_DEST_REGS DISPATCH_II STORE SMEM_DIRECT
...
field:
    ...
    | SMEM_DIRECT EQUALS NUMBER {
         dicemeta_parser->set_num_smem_direct($3);
      }
    | STORE EQUALS NUMBER {
